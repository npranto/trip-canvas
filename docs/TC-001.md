...
**Status:** Done (scope locked for first release)  
**Owner:** You  
**Goal:** Concise project scope document for TripCanvas MVP and what comes after.
...
- Rich user profiles (home airport, default budget, traveler profile, family/kids preferences, hotel style, payment setup)  
