  ...
  return (
    <div className="flex min-h-full flex-col">
      <header className="shrink-0 border-b border-edge bg-background">
        <div className={`${containerClass} flex flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between`}>
          <Link
            href={paths.home}
      ...
      <main className="flex flex-1 flex-col">
        <div className={cn(containerClass, 'flex min-h-0 flex-1 flex-col')}>{children}</div>
      </main>

      <footer className="mt-auto shrink-0 border-t border-edge bg-background">
        <div className={`${containerClass} flex flex-col gap-4 py-6 sm:flex-row sm:items-center sm:justify-between`}>
